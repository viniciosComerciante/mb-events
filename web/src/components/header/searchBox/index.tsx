export function SearchBox() {
  return (
      <div className="relative text-gray-600 focus-within:text-gray-400 flex w-1/2">
        ...
        <input type="text" name="q" className="py-2 text-sm ease-in-out duration-100 text-white bg-primary-700 rounded-md pl-10 focus:outline-none placeholder- focus:bg-white focus:text-gray-900 w-full" placeholder="Pesquisar eventos acadêmicos, empresariais..."/>
      </div>
  );
}
